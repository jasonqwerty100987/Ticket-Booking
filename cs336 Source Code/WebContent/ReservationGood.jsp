...
<form  action="ViewReservation.jsp" method="post" name="ReserveFrom">
	...
	<%
		...
		try {
			...
			String Discount = "Adult";
            if(request.getParameter("Senior_Discount")!= null){
                Discount = "Senior";
            }else if(request.getParameter("Disabled_Discount")!= null){
                Discount = "Disabled";
            }else if(request.getParameter("Children_Discount")!= null){
                Discount = "Children";
            }

            String Way = "";

            if(request.getParameter("One-Way")!= null){
                Way = "OneWay";
            }else if(request.getParameter("Round-trip")!= null){
                Way = "RoundTrip";
			...
			}else if (Way.equals("MonthlyFare")){
			...
			int luckynum = rand.nextInt(9);
			if(luckynum == 0){
				Seat_Class = "first";
			}else if(luckynum == 1||luckynum == 2){
				Seat_Class ="Business";
			}else{
				Seat_Class = "economy";
			}
