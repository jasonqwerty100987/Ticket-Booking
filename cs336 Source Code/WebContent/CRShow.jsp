...
<body>
	...
	<%
		...
		try {
			...
			String str = String.format("SELECT FirstName, LastName from project_336_aws.CustormerRepresentative C WHERE C.Username = '%s' AND C.Password = '%s';",Username, Password);
