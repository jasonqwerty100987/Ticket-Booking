			...
			<div id = "browseText">
				...
				<%
				    try{
						...
						PreparedStatement stat = conn.prepareStatement("SELECT StationID FROM Stations");
						ResultSet s = stat.executeQuery();
				%>
				<form action="ScheduleByStationLogic.jsp" class="browse">
					<div class = "browse">
					    StationID: <select name="point">
						    <%  while(s.next()){ %>
